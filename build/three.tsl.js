...
const mx_acescg_to_lin_rec709 = TSL.mx_acescg_to_lin_rec709;
const mx_adobergb_to_lin_rec709 = TSL.mx_adobergb_to_lin_rec709;
const mx_add = TSL.mx_add;
const mx_atan2 = TSL.mx_atan2;
const mx_blackbody = TSL.mx_blackbody;
const mx_blur = TSL.mx_blur;
const mx_burn = TSL.mx_burn;
const mx_cell_noise_float = TSL.mx_cell_noise_float;
const mx_checkerboard = TSL.mx_checkerboard;
const mx_circle = TSL.mx_circle;
const mx_clamp = TSL.mx_clamp;
const mx_cloverleaf = TSL.mx_cloverleaf;
const mx_combine2 = TSL.mx_combine2;
const mx_combine3 = TSL.mx_combine3;
const mx_combine4 = TSL.mx_combine4;
const mx_contrast = TSL.mx_contrast;
const mx_crosshatch = TSL.mx_crosshatch;
const mx_colorcorrect = TSL.mx_colorcorrect;
const mx_divide = TSL.mx_divide;
const mx_divide_by_zero = TSL.mx_divide_by_zero;
const mx_difference = TSL.mx_difference;
const mx_disjointover = TSL.mx_disjointover;
const mx_dodge = TSL.mx_dodge;
const mx_facingratio = TSL.mx_facingratio;
const mx_fract = TSL.mx_fract;
...
const mx_g18_rec709_to_lin_rec709 = TSL.mx_g18_rec709_to_lin_rec709;
const mx_g22_ap1_to_lin_rec709 = TSL.mx_g22_ap1_to_lin_rec709;
const mx_g22_rec709_to_lin_rec709 = TSL.mx_g22_rec709_to_lin_rec709;
const mx_gooch_shade = TSL.mx_gooch_shade;
const mx_grid = TSL.mx_grid;
const mx_heighttonormal = TSL.mx_heighttonormal;
const mx_hexagon = TSL.mx_hexagon;
const mx_hsvadjust = TSL.mx_hsvadjust;
const mx_hsvtorgb = TSL.mx_hsvtorgb;
const mx_in = TSL.mx_in;
const mx_ifequal = TSL.mx_ifequal;
const mx_ifequal_compare_inputs = TSL.mx_ifequal_compare_inputs;
const mx_ifgreater = TSL.mx_ifgreater;
const mx_ifgreatereq = TSL.mx_ifgreatereq;
const mx_inside = TSL.mx_inside;
const mx_invert = TSL.mx_invert;
const mx_latlongimage = TSL.mx_latlongimage;
const mx_line = TSL.mx_line;
const mx_lin_adobergb_to_lin_rec709 = TSL.mx_lin_adobergb_to_lin_rec709;
const mx_lin_displayp3_to_lin_rec709 = TSL.mx_lin_displayp3_to_lin_rec709;
const mx_mask = TSL.mx_mask;
const mx_matte = TSL.mx_matte;
const mx_minus = TSL.mx_minus;
...
const mx_not = TSL.mx_not;
const mx_open_pbr_anisotropy = TSL.mx_open_pbr_anisotropy;
const mx_out = TSL.mx_out;
const mx_outside = TSL.mx_outside;
const mx_over = TSL.mx_over;
const mx_passthrough = TSL.mx_passthrough;
const mx_place2d = TSL.mx_place2d;
const mx_plus = TSL.mx_plus;
const mx_premult = TSL.mx_premult;
const mx_power = TSL.mx_power;
const mx_ramp = TSL.mx_ramp;
const mx_ramp4 = TSL.mx_ramp4;
const mx_ramp_gradient = TSL.mx_ramp_gradient;
const mx_ramplr = TSL.mx_ramplr;
const mx_ramptb = TSL.mx_ramptb;
const mx_randomfloat = TSL.mx_randomfloat;
const mx_randomcolor = TSL.mx_randomcolor;
const mx_range = TSL.mx_range;
const mx_rgbtohsv = TSL.mx_rgbtohsv;
const mx_rec709_display_to_lin_rec709 = TSL.mx_rec709_display_to_lin_rec709;
const mx_rotate2d = TSL.mx_rotate2d;
const mx_rotate3d = TSL.mx_rotate3d;
const mx_overlay = TSL.mx_overlay;
const mx_safepower = TSL.mx_safepower;
const mx_screen = TSL.mx_screen;
const mx_separate = TSL.mx_separate;
const mx_smoothstep = TSL.mx_smoothstep;
const mx_srgb_displayp3_to_lin_rec709 = TSL.mx_srgb_displayp3_to_lin_rec709;
...
const mx_tiledcircles = TSL.mx_tiledcircles;
const mx_tiledcloverleafs = TSL.mx_tiledcloverleafs;
const mx_tiledhexagons = TSL.mx_tiledhexagons;
const mx_trianglewave = TSL.mx_trianglewave;
const mx_transformmatrix = TSL.mx_transformmatrix;
const mx_transform_point = TSL.mx_transform_point;
const mx_transform_uv = TSL.mx_transform_uv;
const mx_transform_vector = TSL.mx_transform_vector;
const mx_unpremult = TSL.mx_unpremult;
const mx_unifiednoise2d = TSL.mx_unifiednoise2d;
const mx_unifiednoise3d = TSL.mx_unifiednoise3d;
const mx_UsdTransform2d = TSL.mx_UsdTransform2d;
